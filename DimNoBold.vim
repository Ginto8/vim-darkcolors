...
"hi Statement guifg=grey75 gui=none
"hi Statement guifg=grey65 gui=none
"hi Statement guifg=wheat4 gui=none
"hi Statement guifg=#8B7E66 gui=none
hi Statement guifg=#9B8E76 gui=none
...
hi IncSearch guifg=yellow guibg=LightSkyBlue3 gui=none
hi WarningMsg guifg=red guibg=GhostWhite gui=none
hi Error guibg=red3
